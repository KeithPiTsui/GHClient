...
public let discoveryTabBarItemStyle = baseTabBarItemStyle
...
public func activityTabBarItemStyle(isLogin: Bool) -> (UITabBarItem) -> UITabBarItem {
  let offset: CGFloat = isLogin ? 4.0 : 9.0
...
public func profileTabBarItemStyle(isLoggedIn: Bool) -> (UITabBarItem) -> UITabBarItem {
  ...
  let offset: CGFloat = isLoggedIn ? 2.0 : 12.0
